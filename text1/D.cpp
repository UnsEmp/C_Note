...
int main() {
	...
	while( 1 ) {
	    int n = init();
	    switch(n) {
	    	case 0:printf("创建邻接表 :");Graph = BuildGraph();printf("创建成功！\n");break; 
	    	case 1:printf("使用BFS遍历图:");BFS(Graph);break;
	    	case 2:printf("对图进行拓扑排序:");TopSort(Graph, TopOrder);break;
	    	case 3:exit(0);
		}
printf("\n");
		system("pause");
...
void BFS(LGraph Graph) {
	...
	printf("请输入你的起点:\n");
	scanf("%d", &x);
    memset(Visitied, false, MaxVertexNum);
    Queue Q;
